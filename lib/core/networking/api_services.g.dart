...
class _ApiServices implements ApiServices {
  ...
  Future<List<AllCarsModel>> getAllCars() async {
    ...
    try {
      _value = _result.data!
          .map((dynamic i) => AllCarsModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  Future<List<AllBrandsModel>> getAllBrands() async {
    ...
    try {
      _value = _result.data!
          .map(
            (dynamic i) => AllBrandsModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  @override
  Future<List<CarBrandModel>> getCarsByBrand(String brandName) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CarBrandModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<CarBrandModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => CarBrandModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
