...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AllCarsState<T>);
}
...
/// @nodoc
class $AllCarsStateCopyWith<T,$Res>  {
$AllCarsStateCopyWith(AllCarsState<T> _, $Res Function(AllCarsState<T>) __);
}


/// Adds pattern-matching-related methods to [AllCarsState].
extension AllCarsStatePatterns<T> on AllCarsState<T> {
...
class Idle<T> implements AllCarsState<T> {
  const Idle();
...
class Loading<T> implements AllCarsState<T> {
  const Loading();
...
class Success<T> implements AllCarsState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of AllCarsState
...
@override
String toString() {
  return 'AllCarsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AllCarsStateCopyWith<T, $Res> {
...
class Failure<T> implements AllCarsState<T> {
...
@override
String toString() {
  return 'AllCarsState<$T>.failure(apiNetworkExceptions: $apiNetworkExceptions)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $AllCarsStateCopyWith<T, $Res> {
