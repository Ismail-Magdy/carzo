...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CarBrandState<T>);
}
...
/// @nodoc
class $CarBrandStateCopyWith<T,$Res>  {
$CarBrandStateCopyWith(CarBrandState<T> _, $Res Function(CarBrandState<T>) __);
}


/// Adds pattern-matching-related methods to [CarBrandState].
extension CarBrandStatePatterns<T> on CarBrandState<T> {
...
class Idle<T> implements CarBrandState<T> {
  const Idle();
...
class Loading<T> implements CarBrandState<T> {
  const Loading();
...
class Success<T> implements CarBrandState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of CarBrandState
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CarBrandStateCopyWith<T, $Res> {
...
class Failure<T> implements CarBrandState<T> {
...
@override
String toString() {
  return 'CarBrandState<$T>.failure(apiNetworkExceptions: $apiNetworkExceptions)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $CarBrandStateCopyWith<T, $Res> {
